...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const prompt = `Kamu adalah business analyst untuk Coffee Kota Hujan (kafe di Ternate). Buat laporan harian gaya WhatsApp yang ENAK DIBACA owner, dengan emoji dan insight tajam. Format Markdown WhatsApp (*tebal*, _miring_).
...
INSTRUKSI:
1. Mulai dengan judul: 📊 *Laporan Kota Hujan — ${tanggal}*
