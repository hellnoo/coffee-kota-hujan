...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const prompt = `Kamu adalah barista expert di Coffee Kota Hujan (Ternate). Customer sedang di keranjang dan kamu harus rekomendasi 2-3 ITEM TAMBAHAN yang COCOK & MENGGIURKAN.
