...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const prompt = `Kamu adalah konsultan menu kafe yang berpengalaman. Analisis data menu Coffee Kota Hujan berikut (30 hari terakhir):
...
1. Mulai dengan judul: 🧠 *Menu Engineering Kota Hujan*
