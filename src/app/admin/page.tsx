...
function exportCsv(orders: OrderRow[]) {
  ...
  a.download = `kotahujan-rekap-${new Date().toISOString().slice(0, 10)}.csv`
...
export default function AdminPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (res.ok) { localStorage.setItem('kotahujan-admin', 'ok'); setAuthed(true) }
      ...
      <header className="bg-h-dark border-b border-h-border">
        <div className="max-w-5xl mx-auto px-5 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => { localStorage.removeItem('kotahujan-admin'); setAuthed(false) }}
        ...
        {tab === 'pengaturan' && (() => {
          ...
          return (
            <div className="space-y-5 max-w-lg">
              <h1 className="font-sans text-lg font-black text-white uppercase tracking-wider">Pengaturan Kota Hujan</h1>
